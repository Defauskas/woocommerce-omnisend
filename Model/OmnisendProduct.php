...
class OmnisendProduct
{
    ...
    private function __construct($id, $view)
    {
        ...
        if ($view != "picker") {
            ...
            $this->createdAt = empty($wcProduct->get_date_created()) ? date(DATE_ATOM, time()) : $wcProduct->get_date_created()->__toString();
            $this->updatedAt = empty($wcProduct->get_date_modified()) ? date(DATE_ATOM, time()) : $wcProduct->get_date_modified()->__toString();
